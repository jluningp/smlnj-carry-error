...
# Modified from Jacob Van Buren's patch install script at https://github.com/jvanburen/smlnj-warn-unused
...
smlnj="${gf}/smlnj"
patch_url="https://raw.githubusercontent.com/jluningp/smlnj-carry-error/master/carry-error.patch"
...
# Apply patch!
if [ -f compiler/Parse/carry/carry.sml ]; then
  inform_user "(Assuming patch already applied)"
else
  patch --batch -p0 < "./carry-error.patch"
fi
